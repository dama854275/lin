...
<div class="monitor-page w-full max-w-[1500px] mx-auto px-2 sm:px-4">
	...
	<div class="bg-white rounded-lg shadow-md p-6">
		<div class="grid grid-cols-3 items-center mb-4 gap-3">
			<h3 class="text-lg md:text-2xl font-semibold justify-self-start">그룹 계정 목록</h3>
			...
			<button
				...
				class="justify-self-end px-4 py-2 text-sm font-medium rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed"
			>
